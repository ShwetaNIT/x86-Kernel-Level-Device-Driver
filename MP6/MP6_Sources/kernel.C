...
void fun2() {
    ...
    for(int j = 0;; j++) {
       ...
       /* -- Read */
       Console::puts("FUN2: Reading a block from disk...\n");
       ...
       Console::puts("FUN2: Writing a block to disk...\n");
...
void fun3() {
    ...
    for(int j = 0;; j++) {
       ...
       /* -- Read */
       Console::puts("FUN3: Reading a block from disk...\n");
       SYSTEM_DISK->read(read_block, buf);
       ...
       Console::puts("FUN3: Writing a block to disk...\n");
       SYSTEM_DISK->write(write_block, buf); 
